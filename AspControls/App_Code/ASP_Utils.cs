...
{
    public static string Z(this Page p)
    {
        return " <span style='color: red'>*</span>";
    }

    public static void SetHtmlViz(WebControl c)
    {
        if (c.Visible)
    ...
    public static string GetServer(this Page p)
    {
        return p.Request.Url.Authority.ToLower();
    }
    ...
    public static void ShowMessage(this Page p, string msg)
    {
        ShowMessage(msg, p);
    }
}